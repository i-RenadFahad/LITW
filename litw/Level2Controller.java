...
private Integer sec =startTime;
    ...
    public void initialize(URL url, ResourceBundle rb) {
     AudioClip note =new AudioClip(this.getClass().getResource("/sound/level2Voice.mp3").toString());
     note.play();
...
@FXML
  private void check(ActionEvent event) throws IOException {
      ...
      int ans1=Integer.parseInt(answer1.getText());
      int ans2=Integer.parseInt(answer2.getText());
     ...
     { 
        ...
        { 
          Logger.getLogger(Level2Controller.class.getName( )).log(Level.SEVERE,null,ex); 
        }
     }); 
      delay.play();
  ...
  private void Back(ActionEvent event) throws IOException {
        ...
        Scene charcterScene=new Scene(map);
        Stage window =(Stage)((Node)event.getSource()).getScene().getWindow();
